...
define('ENTER_MOBILE_OR_EMAIL', 'enter_mobile_or_email');
define('ENTER_VALID_EMAIL', 'enter_valid_email');
define('PROVIDER_IS_ON_LEAVE_LBL', 'provider_is_on_leave_lbl');
define('INVALID_TIME_FORMAT', 'invalid_time_format');
define('SLOT_IS_IN_THE_PAST', 'slot_is_in_the_past');
define('SERVICE_DURATION_EXCEEDS_AVAILABLE_TIME', 'service_duration_exceeds_available_time');
define('SLOT_IS_FULL', 'slot_is_full');
define('SLOT_LOCK_EXPIRED_OR_INVALID', 'slot_lock_expired_or_invalid');
define('SLOT_LOCK_MISMATCH', 'slot_lock_mismatch');
define('SLOT_CONFIRMED', 'slot_confirmed');
define('LOCK_RELEASED', 'lock_released');
define('LOCK_NOT_FOUND_OR_EXPIRED', 'lock_not_found_or_expired');
define('CANNOT_CANCEL_SERVICE_IN_PROGRESS', 'cannot_cancel_service_in_progress');