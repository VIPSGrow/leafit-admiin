...
class IonAuth extends \IonAuth\Config\IonAuth
{
	 ...
	 */
    public $siteTitle                = 'edemand.in';       // Site Title, example.com
    public $adminEmail               = 'infinitietechnologies01@gmail.com'; // Admin Email, admin@example.com
    public $defaultGroup             = 'members';           // Default group, use name
    public $partnerGroup             = 'partners';
    public $handymanGroup            = 'handyman';
    public $adminGroup               = 'admin';             // Default administrators group, use name
    public $identity                 = 'phone';             /* You can use any unique column in your table as identity column.
																	IMPORTANT: If you are changing it from the default (email),
																				update the UNIQUE constraint in your DB */
    // public $usernameColumn           = 'username';          // Username column in the users table
