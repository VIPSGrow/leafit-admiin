    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="row mt-sm-4">
                <div class="col-md-12">
                    <div class="card">
                        <form action="<?= base_url('user/update-profile') ?>" id="update_user_profile" method="post" accept-charset="utf-8">
                                ...
                                <div class="row ">
                                    <div class="avatar-item col-md-3">
                                        ...
                                        ?>
                                            ...
                                            <a href="<?= base_url('public/uploads/profiles/' . $data['image'])  ?>" data-lightbox="image-1"><img height="100px" src="<?= base_url('public/uploads/profiles/' . $data['image'])  ?>" alt=""></a>
