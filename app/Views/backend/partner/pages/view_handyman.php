    ...
    <section class="section">
        <div class="section-header mt-2">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="<?= base_url('partner/handymen') ?>">
        ...
        <div class="container-fluid card">
            <div class="row p-3 align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="text-muted small">
                        ...
                        <?php if (!empty($handyman['address'])): ?><span><i
            ...
            <div class="card-header p-0">
                <ul class="nav nav-tabs card-header-tabs px-3" id="viewHandymanTabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-body" id="tab-cash" data-toggle="tab" href="#pane-cash" role="tab"><i
                                class="fas fa-money-bill-wave mr-2"></i><?= labels('cash_collections', 'Cash Collections') ?></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content p-3">
                            ...
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-money-bill-wave text-success mr-2"></i><?= labels('total_cash_collected', 'Total Cash Collected') ?>
                                    </div>
                                    <h4 class="mb-0" id="stat_total_collected"><?= esc($currency) ?> 0.00</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-hand-holding-usd text-danger mr-2"></i><?= labels('outstanding_balance', 'Outstanding Balance') ?>
                                    </div>
                                    <h4 class="mb-0" id="stat_outstanding"><?= esc($currency) ?> 0.00</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-star text-warning mr-2"></i><?= labels('average_rating', 'Average Rating') ?>
                                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md col-6 mb-3 mb-md-0">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-clipboard-list text-primary mr-2"></i><?= labels('total_bookings', 'Total Bookings') ?>
                                    </div>
                        ...
                        <div class="col-md col-6 mb-3 mb-md-0">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-star text-warning mr-2"></i><?= labels('lead_bookings', 'Lead Bookings') ?>
                                    </div>
                        ...
                        <div class="col-md col-6 mb-3 mb-md-0">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-calendar-day text-info mr-2"></i><?= labels('today_bookings', "Today's Bookings") ?>
                                    </div>
                        ...
                        <div class="col-md col-6 mb-3 mb-md-0">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-calendar-alt text-secondary mr-2"></i><?= labels('upcoming_bookings', 'Upcoming Bookings') ?>
                                    </div>
                        ...
                        <div class="col-md col-6">
                            <div class="card border shadow-sm">
                                <div class="card-body">
                                    <div class="text-muted"><i
                                            class="fas fa-check-circle text-success mr-2"></i><?= labels('completed_bookings', 'Completed Bookings') ?>
                                    </div>
                ...
                <div class="tab-pane fade" id="pane-bookings" role="tabpanel">
                    <div class="table-responsive">
                        <table class="table table-hover" id="handyman_bookings_table" data-toggle="table"
                            ...
                            data-url="<?= base_url('partner/handymen/bookings-list/' . (int) $handyman['id']) ?>"
                ...
                <div class="tab-pane fade" id="pane-cash" role="tabpanel">
                    <div class="table-responsive">
                        <table class="table table-hover" id="handyman_cash_table" data-toggle="table"
                            data-side-pagination="server" data-pagination="true"
                            data-url="<?= base_url('partner/handymen/cash-collection-list/' . (int) $handyman['id']) ?>"
                            data-page-list="[10, 25, 50, 100]" data-pagination-successively-size="2"
                            data-show-refresh="false" data-search="false" data-show-columns="false"
                            data-show-export="false" data-sort-name="hcc.id" data-sort-order="desc">
                            <thead class="thead-light">
                                <tr>
                                    <th data-field="order_id" class="text-center"><?= labels('order_id', 'Order Id') ?>
                                    </th>
                                    ...
                                    <th data-field="type_badge" class="text-center"><?= labels('type', 'Type') ?></th>
                                    <th data-field="amount_display" class="text-center">
                                        <?= labels('amount', 'Amount') ?>
                                    </th>
                                    <th data-field="message" class="text-center"><?= labels('message', 'Message') ?>
                                    </th>
                                    <th data-field="created_at_display" class="text-center">
                                        <?= labels('date', 'Date') ?>
                                    </th>
                                </tr>
                            </thead>
                ...
                <div class="tab-pane fade" id="pane-reviews" role="tabpanel">
                    <div class="table-responsive">
                        <table class="table table-hover" id="handyman_reviews_table" data-toggle="table"
                            data-side-pagination="server" data-pagination="true"
                            data-url="<?= base_url('partner/handymen/reviews-list/' . (int) $handyman['id']) ?>"
                            data-page-list="[10, 25, 50, 100]" data-pagination-successively-size="2"
                            data-show-refresh="false" data-search="false" data-show-columns="false"
...
<script>
    ...
    function loadHandymanOverview() {
        ajaxRequest('GET', '<?= base_url('partner/handymen/overview/') ?>' + HANDYMAN_ID, null, null, function (res) {
            $('#stat_total_collected').text(CURRENCY + ' ' + res.total_cash_collected);
            $('#stat_outstanding').text(CURRENCY + ' ' + res.outstanding_balance);
            ...
            var recentCompletedData = res.recent_completed_bookings.map(function (row) {
                var viewUrl = '<?= base_url('partner/orders/veiw_orders/') ?>' + row.order_id;
                return {
    ...
    function initHandymanMap(mapData) {
        ...
        LiveTrackingMap.init({
            ...
            pollUrl: '<?= base_url('partner/handymen/tracker-location/') ?>' + HANDYMAN_ID,
    ...
    $(document).ready(function () {
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            else if (target === '#pane-cash') $('#handyman_cash_table').bootstrapTable('refresh');
