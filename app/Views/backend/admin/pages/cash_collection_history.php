                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderd" data-pagination-successively-size="2" id="cash_collection"
                                data-show-export="false" data-export-types="['txt','excel','csv']" data-export-options='{"fileName": "invoice-order-list","ignoreColumn": ["action"]}'
                                ...
                                data-side-pagination="server" data-pagination="true" data-url="<?= base_url('admin/partners/cash_collection_history_list'); ?>" data-sort-name="id" data-sort-order="desc"
                                data-query-params="cash_collection_history_query_params">
                                <thead>
                                    <tr>
                                        <th data-field="partner_name" class="text-center" data-visible="true"><?= labels('partner', 'Provider')  ?></th>
                                        <th data-field="message" class="text-center" data-visible="true"><?= labels('message', 'message')  ?></th>
                                        <th data-field="commison" class="text-center" data-visible="true"><?= labels('amount', 'amount')  ?>(<?= $data['currency'] ?>)</th>
                                        <th data-field="order_id" class="text-center" data-visible="true"><?= labels('order_id', 'Order ID')  ?></th>
                                        <th data-field="date" class="text-center" data-visible="true"><?= labels('date', 'date')  ?></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
