                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="old_image" id="old_image" value="<?= htmlspecialchars($promocode['raw_image'] ?? '') ?>">
                                            <?php if (!empty($promocode['image'])) : ?>
                                                <div class="mt-2">
                                                    <img src="<?= $promocode['image'] ?>" alt="<?= labels('current_image', 'Current Image') ?>" style="height: 60px; width: 60px; object-fit: cover; border-radius: 4px; border: 1px solid #dee2e6;">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
