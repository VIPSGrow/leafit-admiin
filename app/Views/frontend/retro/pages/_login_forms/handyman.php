...
<input type="hidden" name="login_context" value="handyman">
...
<div class="mb-3">
    ...
    <div class="phone-input-group">
        ...
        <div class="country_code d-flex align-items-center flex-shrink-0">
...
<script>
    $(document).ready(function () {
        $('#forgot-password-link').attr('href', '<?= site_url(route_to('auth-forgot-password')) ?>?userType=handyman');
        ...
        if (!isSingleCountryCode && $('#country_code').is('select')) {
            ...
            $('#country_code').val('<?= $default_calling_code ?>').trigger('change');
        }
    });
</script>
